extends MainLoop
## Re-parses the EXPORTED thug.glb and measures the rig. Adapted from tools/probe_rig.gd.
...
func _initialize() -> void:
	var scn := SuitLoader.load_suit("res://assets/suits/thug.glb")
	if scn == null:
	...
	print("--- thug.glb: ", names.size(), " pivots, ", meshes.size(), " meshes ---")
