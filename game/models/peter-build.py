...
# ---------------------------------------------------------------- hips (jeans)
hips_prof = [
    (1.060, 0.086, 0.073, 0.000),
    (1.020, 0.096, 0.080, 0.000),
    (0.950, 0.117, 0.095, 0.000),
    (0.905, 0.127, 0.102, 0.002),                # seat
    (0.868, 0.129, 0.100, 0.000),
    (0.838, 0.121, 0.089, -0.004),
    (0.815, 0.106, 0.070, -0.004),
    (0.800, 0.079, 0.047, -0.004),               # crotch
]
